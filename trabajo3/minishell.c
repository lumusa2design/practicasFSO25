...
int main(int argc, char *argv[]) {
    ...
    while (1) {
        ...
        if (!strcmp(token, "cerrar_sala")) {
        ...
        } else if (!strcmp(token, "estado_sala")) {
            print_estado_sala();
            ...
            fprintf(stderr, "Comando desconocido. Escribe \"ayuda\" para ver la lista de comandos.\n");
        }
    }
}
